    ...
    <section class="articles">
      ...
      <div class="panel panel-default">
          <div class="panel-heading">
              <div class="col-md-10">
                <h3 class="panel-title">Editer l'article</h3>
              </div>
              <div class="col-md-2">
        ...
        <div class="well">
            ...
            <form action="#" method="post">
                ...
                <div class="form-group">
                  <label>Titre</label>
                  <input type="text" class="form-control" name="title" id="title" placeholder="Ajouter un titre" value="<?php echo $article->title(); ?>"required>
                </div>

                <div class="form-group">
                  <label>Contenu</label>
                  <textarea name="content" class="form-control" id="content" rows="8" cols="80"><?php echo $article->content(); ?></textarea>
                </div>
